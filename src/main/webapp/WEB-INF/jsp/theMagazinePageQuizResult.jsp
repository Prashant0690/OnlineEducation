           ...
           <c:forEach items="${pageQuesList}" var="quesModel" varStatus="status">
             <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-justify">
                    ...
                    <div >
					  <span>Option1  :</span><label>${quesModel.option1}</label>
					</div>
					<div >
					  <span>Option2  :</span><label>${quesModel.option2}</label>
					</div>
					<div>
					  <span>Option3  :</span><label>${quesModel.option3}</label>
					</div>
					<div>
					  <span>Option4  :</span><label>${quesModel.option4}</label>
					</div>
					
					<div>
					  <h4 class="section-heading">Result :${quesModel.result}</h4>
					  <h4 class="section-heading">Solution :${quesModel.ansDescription}</h4>
					</div>
