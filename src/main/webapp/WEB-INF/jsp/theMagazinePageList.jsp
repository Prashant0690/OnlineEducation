    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li class="active"><a href="index.html">Contents</a></li>
                </ol>
            </div>
        </div>
...
<!-- Blog Post Row -->
        ...
        <div class="row">
            <div class="col-md-1 text-center">
                ...
                <p><fmt:formatDate pattern="MMM-dd-yyyy" value="${updateItem.updateDate}" /></p>
            </div>
            
            <div class="col-md-11">
                <h3><a href="blog-post.html">${magazinePage.pageTitle}</a></h3>
                <p>${magazinePage.pageSubTitle}.</p>
                <a class="btn btn-primary" 
                	href='<spring:url value="/classroom/TheMagazineCourse/${courseModel.courseId}/${courseModel.courseName}/page/${magazinePage.pageId}.html" />'>
